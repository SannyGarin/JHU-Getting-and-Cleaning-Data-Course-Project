Guide to push data into this repo

```git remote add origin https://github.com/SannyGarin/JHU-Getting-and-Cleaning-Data-Course-Project.git```
 ...
 * The following steps were performed in a PC running the operation system Window 8.1.
     ...
     + put the raw data sets in the selected working directory called "JHU-Getting-and-Cleaning-Data-Course-Project"
       that is same name as in a repo in my Github account. 
       (In other words, my working directory: "C:/Users/ JHU-Getting-and-Cleaning-Data-Course-Project")
        
     		  >getwd()
        
     		  [1] "C:/Users/JHU-Getting-and-Cleaning-Data-Course-Project"
...
#### R code: run_analysis.R
	...
	## run_analysis.R
	## author: sannygarin (gitHub username)
	## 
...
####### read and merge label-data set pair ##############################
	...
	##  "standard deviation" stored in the file "features.txt" via the command grep
	     ...
	     features <- read.table("./UCI HAR Dataset/features.txt") ##read/load the file
